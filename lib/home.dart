...
import 'package:session01/about.dart';
import 'package:session01/wifi.dart';
              ...
              ListTile(
                ...
                onTap: () {
                  Navigator.push(context,
                      MaterialPageRoute(builder: (_) => Wifi(name: "Ragnar")));
                  Navigator.pop(context);
                },
              ),
            ],
              ...
              child: OutlineButton(
                onPressed: () async {
                  showDialog(
                      ...
                      builder: (_) {
                        return SimpleDialog(
                          title: Text('Please choose the image source?'),
                          children: [
                            ListTile(
                              onTap: () async {
                                Navigator.pop(context);
